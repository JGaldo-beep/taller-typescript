...
var createCard = function (serie) {
	return '\n    <div class="card">\n        <img src="'
		.concat(serie.imageUrl, '" class="card-img-top"  alt="')
		.concat(
			serie.name,
			'">\n        <div class="card-body">\n        <h5 class="card-title">'
		)
		.concat(serie.name, '</h5>\n        <p class="card-text">')
		.concat(serie.description, '</p>\n        <a href="')
		.concat(
			serie.url,
...
if (tableBody && detailsContainer) {
	...
	series.forEach(function (serie, index) {
		var row = '<tr class="serie-row" data-id="'
			.concat(serie.id, '">\n                        <th scope="row">')
			.concat(index + 1, "</th>\n                        <td>")
